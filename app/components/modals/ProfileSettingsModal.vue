				...
				>
					<div class="h-32">
						<div
							...
							:style="{
								backgroundImage: `url(${previews.banner || `http://localhost:8333/user-banners/${user?.id}`})`,
							}"
						>
							<label
					...
					<div
						...
						:style="{
							backgroundImage: `url(${previews.avatar || `http://localhost:8333/user-avatars/${user?.id}`})`,
						}"
					>
						<label
